...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{url('home')}}" class="brand-link">
      ...
      <span class="brand-text font-weight-bolder">Indomerce</span>
    </a>
  ...
  <!-- /.content-wrapper -->
  <footer class="main-footer flex justify-center">
    <strong>Copyright © 2023, Developed by Omarpasya & Azhary
  </footer>
